...
class CampusSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // You can now use $campusDirectoryArr to seed your database
        // For example, if you have models for Campus, College, Program, etc.
        // Or store it in a config file or database table

        // Example: Store in a config or cache for use in the application
        // config(['campus_directory' => $campusDirectoryArr]);
    }
}